        ...
        stage('Build') {
            ...
            steps {
                script {
                    ...
                    checkout changelog: false, scm: [$class: 'GitSCM', branches: [[name: "${env.branch}"]], extensions: [], userRemoteConfigs: [[credentialsId: '44c2f71b-79a4-45c8-9b68-42e1e4d5770f', url: 'https://github.com/mykshtompel/pipeline.git']]]
